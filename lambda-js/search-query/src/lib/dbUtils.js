...
function getFoldersForUserId(userId) {
    ...
    return mysql.createConnection({
        ...
        return connection.query(mysql.format(getUserRolesSql, [userId, userId, userId, userId]));
        ...
        getPersonalFoldersSql = mysql.format(getPersonalFoldersSql, [userRoleIds]);
        console.log(getPersonalFoldersSql);
        return connection.query(getPersonalFoldersSql);
        ...
        console.log("got libraryFolders: ", personalFolderUuids.join(","))

        // query for user's visible-library-folders
        getLibraryFoldersSql = mysql.format(getLibraryFoldersSql, [userRoleIds]);
        console.log(getLibraryFoldersSql);
        return connection.query(getLibraryFoldersSql);
        ...
        getUserResourceFolderSql = mysql.format(getUserResourceFolderSql, [userId]);
        console.log(getUserResourceFolderSql);
        return connection.query(getUserResourceFolderSql);
