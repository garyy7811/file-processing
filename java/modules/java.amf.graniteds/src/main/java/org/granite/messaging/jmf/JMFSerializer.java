...
public class JMFSerializer implements OutputContext {
	...
	public String toDumpString() {
		final Comparator<Entry<?, Integer>> comparator = new Comparator<Entry<?, Integer>>() {
			@Override
		...
		TreeSet<Entry<String, Integer>> setStringInteger = new TreeSet<Entry<String, Integer>>(comparator);
		setStringInteger.addAll(classNames.entrySet());
		sb.append("    classNames=[\n");
		for (Entry<String, Integer> entry : setStringInteger)
			sb.append("        ").append(entry.getValue()).append(": \"").append(entry.getKey()).append("\"\n");
		sb.append("    ],\n");
		
		setStringInteger = new TreeSet<Entry<String, Integer>>(comparator);
		...
		TreeSet<Entry<Object, Integer>> setObjectInteger = new TreeSet<Entry<Object, Integer>>(comparator);
		setObjectInteger.addAll(objects.entrySet());
		sb.append("    objects=[\n");
		for (Entry<Object, Integer> entry : setObjectInteger) {
